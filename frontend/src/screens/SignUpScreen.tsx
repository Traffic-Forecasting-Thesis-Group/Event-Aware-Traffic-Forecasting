...
export default function SignUpScreen({ navigation }: any) {
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      //remove the line above when backend is ready and replace the line below with the actual signUp function call
                ...
                <View style={styles.inputWrapper}>
                  <View style={[
                    ...
                    <MaterialCommunityIcons
                      name="account-outline" size={22}
                      color={errors.name ? '#ef4444' : focusedInput === 'name' ? '#4475F2' : '#9ca3af'}
